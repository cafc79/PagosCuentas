...
namespace PAT.PrivilegesManagement.Common;
...
public static class StartupExtensions
    {
        ...
        private static IServiceCollection AddApplicationServices(
            this IServiceCollection services)
            => services
                .AddTransient<IAuthApplication, AuthApplication>()
                .AddTransient<IUserApplication, UserApplication>()
                .AddTransient<IRoleApplication, RolApplication>()
