...
namespace PAT.Scheduler.Common
{
    ...
    public static class StartupExtensions
    {
        ...
        public static void ConfigureUserManagement(this IFunctionsHostBuilder builder)
        {
            ...
            builder.Services
                ...
                .AddSettings<ERPSettings>(nameof(ERPSettings))
                .AddSettings<FinerioSettings>(nameof(FinerioSettings));
        }
        ...
        private static IServiceCollection AddApplicationServices(
            ...
            => services
               ...
               .AddTransient<ISyncFinerioService, SyncFinerioService>()
               .AddTransient<ISyncSchedulerApplication, SyncSchedulerApplication>()
